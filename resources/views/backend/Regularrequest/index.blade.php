...
@section ('title', trans('labels.backend.access.regular-request.main-title') . ' | ' . trans('labels.backend.access.regular-request.filter-emp'))
...
@section('page-header')
    <h1>
        {{ trans('labels.backend.access.regular-request.main-title') }}
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.access.regular-request.filter-emp') }}</h3>
